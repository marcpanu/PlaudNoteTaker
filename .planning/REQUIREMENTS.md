...
| MIGR-01 | Phase 3 — Core Daemon | Complete |
| MIGR-02 | Phase 3 — Core Daemon | Complete |
| MIGR-03 | Phase 3 — Core Daemon | Complete |
| MIGR-04 | Phase 3 — Core Daemon | Complete |
| MIGR-05 | Phase 3 — Core Daemon | Complete |
| MIGR-06 | Phase 3 — Core Daemon | Complete |
| SETT-01 | Phase 3 — Core Daemon | Complete |
| SETT-02 | Phase 3 — Core Daemon | Complete |
| SETT-03 | Phase 3 — Core Daemon | Complete |
| SETT-04 | Phase 3 — Core Daemon | Complete |
| SETT-05 | Phase 3 — Core Daemon | Complete |
| SETT-06 | Phase 3 — Core Daemon | Complete |
| SETT-07 | Phase 3 — Core Daemon | Complete |
| SPEK-01 | Phase 3 — Core Daemon | Complete |
| SPEK-02 | Phase 3 — Core Daemon | Complete |
| LLGN-01 | Phase 3 — Core Daemon | Complete |
| LLGN-02 | Phase 3 — Core Daemon | Complete |
| DAEM-01 | Phase 3 — Core Daemon | Complete |
| DAEM-02 | Phase 3 — Core Daemon | Complete |
| DAEM-03 | Phase 3 — Core Daemon | Complete |
| DAEM-04 | Phase 3 — Core Daemon | Complete |
| DAEM-05 | Phase 3 — Core Daemon | Complete |
| LOGS-01 | Phase 3 — Core Daemon | Complete |
| LOGS-02 | Phase 3 — Core Daemon | Complete |
| LOGS-03 | Phase 3 — Core Daemon | Complete |
| MBAR-05 | Phase 3 — Core Daemon | Complete |
| MBAR-08 | Phase 3 — Core Daemon | Complete |
| POPO-01 | Phase 4 — User Surface | Complete |
| POPO-02 | Phase 4 — User Surface | Complete |
| POPO-03 | Phase 4 — User Surface | Complete |
| POPO-04 | Phase 4 — User Surface | Complete |
| POPO-05 | Phase 4 — User Surface | Complete |
| POPO-06 | Phase 4 — User Surface | Complete |
| MBAR-03 | Phase 4 — User Surface | Complete |
| MBAR-04 | Phase 4 — User Surface | Complete |
| NOTF-01 | Phase 4 — User Surface | Complete |
| NOTF-02 | Phase 4 — User Surface | Complete |
| NOTF-03 | Phase 4 — User Surface | Complete |
| NOTF-04 | Phase 4 — User Surface | Complete |
| BRDG-01 | Phase 4 — User Surface | Complete |
| BRDG-02 | Phase 4 — User Surface | Complete |
| BRDG-03 | Phase 4 — User Surface | Complete |
